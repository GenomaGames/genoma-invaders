...
redirect_from:
  ...
  - /tutorials/01-getting-started-with-unity-2d-game-development/index.html
---
...
![01-Unity_2020_blank_2D_project](../assets/lesson-01/01-Unity_2020.1_blank_2D_project.png)
...
![02-Unity_GameObject_2D_Object_Sprite_menu](../assets/lesson-01/02-Unity_GameObject_2D_Object_Sprite_menu.png)
...
![03-Unity_Inspector_Player_Game_Object](../assets/lesson-01/03-Unity_Inspector_Player_Game_Object.png)
...
Time to inject some graphics into the game. Take this [Player sprite](../assets/lesson-01/Player.png):
...
![04-Unity_Inspector_Sprite_Selection](../assets/lesson-01/04-Unity_Inspector_Sprite_Selection.png)
...
![05-Unity_Game_Panel](../assets/lesson-01/05-Unity_Game_Panel.png)
...
![06-Unity_Inspector_window_Texture_2D_Import_Settings](../assets/lesson-01/06-Unity_Inspector_window_Texture_2D_Import_Settings.png)
...
![07-Unity_Inspector_window_Import_Settings_for_Pixel_Art_16_pixels](../assets/lesson-01/07-Unity_Inspector_window_Import_Settings_for_Pixel_Art_16_pixels.png)
...
![08-Unity_Game_view_pixel_player](../assets/lesson-01/08-Unity_Game_view_pixel_player.png)
...
![09-Unity_Window_menu](../assets/lesson-01/09-Unity_Window_menu.png)

Set **Packages** option to show **All** packages.

![10-Unity_Package_Manager_window_Package_filter](../assets/lesson-01/10-Unity_Package_Manager_window_Package_filter.png)

Select the **2D Pixel Perfect** package and the press the **Install** button.

![11-Unity_Package_Manager_2D_Pixel_Perfect_Install](../assets/lesson-01/11-Unity_Package_Manager_2D_Pixel_Perfect_Install.png)
...
![12-Unity_Add_Component_Pixel_Perfect_Camera](../assets/lesson-01/12-Unity_Add_Component_Pixel_Perfect_Camera.png)
...
![13-Unity_Pixel_Perfect_Camera_Component](../assets/lesson-01/13-Unity_Pixel_Perfect_Camera_Component.png)
...
![16-Unity_Game_view_aspect_selected](../assets/lesson-01/16-Unity_Game_view_aspect_selected.png)

Stop the game by pressing the **Play** button again.

## Enemies

Let's make the same process with this [Enemy sprite](../assets/lesson-01/Enemy.png):

![Enemy](../assets/lesson-01/Enemy.png)
...
![17-Unity_Editor_create_sprite_object_in_scene](../assets/lesson-01/17-Unity_Editor_create_sprite_object_in_scene.png)
...
![18-Unity_Editor_Scene_Game_Object_move](../assets/lesson-01/18-Unity_Editor_Scene_Game_Object_move.png)
...
![19-Unity_Editor_Scene_Game_Object_duplication](../assets/lesson-01/19-Unity_Editor_Scene_Game_Object_duplication.png)
